...
if (equipmentOne === 'scanner' || equipmentTwo === 'scanner') {
    ...
    if (encounterAliens == 'y') {
        ...
        if (equipmentOne === 'las gun' || equipmentTwo === 'las gun') {
            ...
            if (fightAliens == 'y') {
                console.log("You fight against the aliens holding the exploration team hostage and are able to successfully rescue the exploration team. Congratulations!");
                process.exit();
            } else {
    ...
    if (equipmentOne === 'hover bikes' || equipmentTwo === 'hover bikes') {
        ...
        if (mountRange === 'm') {
            ...
            if (equipmentOne === 'las gun' || equipmentTwo === 'las gun') {
                ...
                if (fightAliens == 'amb') {
                    console.log("You set up an ambush on the alien convoy and successfully rescue the exploration team. Congratulations!");
                    process.exit();
                } else if (fightAliens == 'dir') {
                    console.log("You try to directly attack the aliens, but their forces are too great for your team to overcome.  You and your team are defeated and taken as prisoners.  Game Over.")
                    process.exit();
                } else {
            ...
            console.log("You head into the jungle and notice that the tracks lead deep into the forest.  At the end of the tracks, you find a series of cocoons in the tree-line that you suspect are the exploration team.")
            if (equipmentOne === 'translator' || equipmentTwo === 'translator') {
                ...
                if (alienHelp == 'y') {
                    ...
                    if (followIns == 'n') {
                        console.log("You follow the alien's instructions and in doing so you see strange bugs disperse that were camouflaged on the cocoons.  After the bugs disperse, your team quickly opens and gets the captives out and escape.");
                        console.log("You meet up later with the aliens and after resting with their tribe, set up diplomatic relations that help foster positive relations with these people.  Congratulations!");
                        process.exit();
                    }   else {
                    ...
                    console.log("'Suit yourself.' The furry being runs away.  You try to formulate a plan with your team, but as you do so, you feel a sting and you begin to get droopy.  Before your eyes close forever, you feel yourself being picked up and wrapped in a sticky substance.  Game Over.")
                    process.exit()
                }
                ...
                if (fightAliens == 'y') {
                    ...
                    console.log("Your team tries to steathily approach the aliens, but as you approach the cocoons, you feel a strange crawling sensation and pricks on your skin.  Small bugs swarm over your bodies as you fall helplessly to the ground, paralyzed until the large aliens awaken and silence you forever.  Game Over.")
                    process.exit()
                }
            } else if (equipmentOne === 'rations' || equipmentTwo === 'rations') {
                console.log("You realize that these aliens might be hunting, and with the rations your team brought you might be able to lure them away.  You can either set the rations far away or try to use a team member as bait with the rations to lure the aliens away.");
